...
spam_list = read_in("./datasets/enron2/spam")
ham_list = read_in("./datasets/enron2/ham")
...
print("advertisement in HAM:")
concordance(ham_list, "advertisement")
print("\n\advertisement in SPAM:")
concordance(spam_list, "advertisement")
